...
each regular grid a D-linear basis function (\Otime{D}) is built and evaluated
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.48\textwidth]{adaptive_sparse_grid_deco_1.pdf}
  \hspace{0cm}
  \includegraphics[width=0.48\textwidth]{adaptive_sparse_grid_deco_2.pdf}

...
patterns) are visible when a high degree of parallelism is achieved, situation
which happens in the case of large grids. Thus, this context is a good
...
by \cite{cuda}. The GPU version is 28.3x faster than the CPU

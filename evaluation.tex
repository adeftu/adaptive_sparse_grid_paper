...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.4\textwidth]{hier_cpu} \\
  \vspace{5pt}
  \includegraphics[width=0.4\textwidth]{hier_gpu}
  \caption{Impact of optimizations on the performance of
  \textit{hierarchization} algorithm}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.4\textwidth]{eval_cpu} \\
  \vspace{5pt}
  \includegraphics[width=0.4\textwidth]{eval_gpu}

...
224, and 256, but chose only the most performant in each case. A pattern could
not be observed, results varying from configuration to configuration and also
...
interpolation points, we used the GPU main memory. Although caching is
